...
const Home = () => {
  return (
    <div className="flex flex-col items-center w-screen h-screen justify-between">
      <div className="mt-10">
        {/* Title */}
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-wide mb-3 mt-14">
            UIC Course Analytics
          </h1>
          <p className="text-lg text-gray-600 mb-10 opacity-80">
            Explore grade trends, instructor performance, course history, and
            more.
          </p>
        </div>

        <div className="w-3/4 grid grid-cols-3 gap-4 auto-rows-fr justify-self-center">
      ...
      <div className="mt-14 text-gray-500 text-sm opacity-70 mb-4">
        <div className="flex gap-1 ">
          {`© ${new Date().getFullYear()} UIC Course Analytics - `}
          <div className="text-gray-500 text-sm opacity-70 hover:text-blue-500 underline">
